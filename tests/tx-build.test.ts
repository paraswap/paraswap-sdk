...
describe('ParaSwap buildTxLocally', () => {
  ...
  test('Uniswap_ETH_DAI_buy', async () => {
    console.log(
      'buildTxLocally output:',
      await buildTxLocally(paraSwap, {
        srcToken: {
        ...
        minMaxAmount: '690579825750453800',
        priceRoute: {
          destAmount: '600000000000000000000',
          srcAmount: '590579825750453800',
          bestRoute: [
            {
              exchange: 'Uniswap',
              destAmount: '600000000000000000000',
              ...
              data: {
                tokenFrom: '0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE',
                tokenTo: '0x6B175474E89094C44Da98b954EedeAC495271d0F',
                gasUSD: '10.6460900197184',
              },
              srcAmountNoFeeAdded: '590579825750453800',
              destAmountNoFeeAdded: '600000000000000000000',
            },
          ],
          multiRoute: [],
          side: 'BUY',
