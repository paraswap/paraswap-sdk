...
export default abstract class Adapter {
  ...
  isWETHAddress = (address: string, network: number) =>
    address.toLowerCase() === Weth.getAddress(network).toLowerCase();
  ...
  protected abstract async ethToTokenSwap(
    srcToken: Address,
    destToken: Address,
    data: DEXData,
  ): Promise<DexParams>;

  protected abstract async tokenToEthSwap(
    srcToken: Address,
    destToken: Address,
    data: DEXData,
  ): Promise<DexParams>;

  protected abstract async tokenToTokenSwap(
    srcToken: Address,
    destToken: Address,
    data: DEXData,
  ): Promise<DexParams>;
