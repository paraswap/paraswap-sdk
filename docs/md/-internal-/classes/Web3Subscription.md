...
> `protected` **\_buildSubscriptionParams**(): [`Web3APIParams`](../namespaces/Users_alexeyshchur_Desktop_Repos_paraswap-sdk_node_modules_web3-types_lib_commonjs_index/type-aliases/Web3APIParams.md)\<`API`, `"eth_subscribe"`\>

#### Returns

[`Web3APIParams`](../namespaces/Users_alexeyshchur_Desktop_Repos_paraswap-sdk_node_modules_web3-types_lib_commonjs_index/type-aliases/Web3APIParams.md)\<`API`, `"eth_subscribe"`\>
