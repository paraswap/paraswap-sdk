...
> `protected` **formatSubscriptionResult**(`data`): [`SyncOutput`](../namespaces/Users_alexeyshchur_Desktop_Repos_paraswap-sdk_node_modules_web3-types_lib_commonjs_index/interfaces/SyncOutput.md)

#### Parameters

• **data**: [`SyncOutput`](../namespaces/Users_alexeyshchur_Desktop_Repos_paraswap-sdk_node_modules_web3-types_lib_commonjs_index/interfaces/SyncOutput.md)

#### Returns

[`SyncOutput`](../namespaces/Users_alexeyshchur_Desktop_Repos_paraswap-sdk_node_modules_web3-types_lib_commonjs_index/interfaces/SyncOutput.md)
