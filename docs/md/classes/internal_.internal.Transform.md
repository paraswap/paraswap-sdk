[@paraswap/sdk](../README.md) / [Exports](../modules.md) / [<internal\>](../modules/internal_.md) / [internal](../modules/internal_.internal.md) / Transform
...
The buffered data will be flushed when either the [uncork](internal_.internal.Transform.md#uncork) or [end](internal_.internal.Transform.md#end) methods are called.
...
Calling the [write](internal_.internal.Transform.md#write) method after calling [end](internal_.internal.Transform.md#end) will raise an error.
...
The `writable.uncork()` method flushes all data buffered since [cork](internal_.internal.Transform.md#cork) was called.
...
recommended to encapsulate the logic into a `Readable` and use [pipe](internal_.internal.Transform.md#pipe). However, if calling `write()` is preferred, it is
